...
function changePriority(domRef) {
    // Change in DOM
    const currentPriority = domRef.getAttribute('data-priority'); //p2
    const currentTicketContainerRef = domRef.closest('.ticket-container'); //single ticket
    const taskId = currentTicketContainerRef.getAttribute('data-id'); //date.now
